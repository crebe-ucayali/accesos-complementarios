# Criterios de mantenimiento del repositorio AC
...
Los directorios deben basarse en fuentes oficiales o datos verificables. Cuando un dato no pueda confirmarse plenamente, debe indicarse como referencia a verificar o enlazarse directamente a la fuente oficial.

## Páginas generales

Las páginas informativas deben mantenerse breves, orientativas y útiles para el usuario. Deben evitar duplicidad innecesaria y conservar una estructura comprensible.

## Recursos complementarios

Los recursos como galería, calendario o firma de visita deben utilizarse con fines informativos o participativos. No deben recopilar datos sensibles ni mostrar imágenes sin autorización.
